    ...
    <div className="p-6 w-full flex items-center justify-center flex-col">
      ...
      <div className="max-w-7xl bg-amber-100 px-12 py-5 mt-2 mb-8 rounded-lg flex flex-col items-center">
        ...
        <div className='flex flex-col gap-y-5 md:grid md:grid-cols-2'>
          <img className='place-self-center rounded-xl w-auto h-60 md:h-[90%] object-cover' src='https://asset-a.grid.id//crop/0x0:0x0/700x465/photo/2023/03/05/food-categoriesjpg-20230305103538.jpg' alt='About Us' />
          <div className='text-md pl-12 py-auto place-self-center text-center md:text-start'>
